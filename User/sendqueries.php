...
<body>
  ...
  <div class="page">
    <div class="left">
      <h1>Give your feedback to  <span>PowerPay</span></h1>
    </div>
  <div class="down">
    ...
    <form method="POST">
      ...
      <button class="submit-btn" name="sendquery" type="submit">Submit Query</button>
    </form>    
  </div>
  </div>
  <div class="right">
  ...
  <div style="text-align:center; padding:15%;">
    <p style="font-size:50px; font-weight:bold;">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['query'])) {
          ...
          $insert_query = "INSERT INTO `queries` (user_id, admin_id, query_text) VALUES ('$user_id', '$admin_id', '$query_text')";
          if (mysqli_query($conn, $insert_query)) {
              $message = "Your query has been sent to the admin!";
          } else {
              $message = "Error submitting the query: " . mysqli_error($conn);
          }
      }
